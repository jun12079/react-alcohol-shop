      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
              ...
              <div className="row mb-3">
                ...
                <div className="col-md-6">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="number" className="form-control" id="origin_price" name="origin_price" placeholder="請輸入原價" min="0" value={modalData.origin_price} onChange={handleModalInputChange} />
                  </div>
                  <div className="mb-3">
                    <label htmlFor="price" className="form-label">售價</label>
                    <input type="number" className="form-control" id="price" name="price" placeholder="請輸入售價" min="0" value={modalData.price} onChange={handleModalInputChange} />
                  </div>
                  <div className="mb-3">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-primary" onClick={handleUpdateProduct} disabled={isLoading}>確認</button>
          </div>
        </div>
      </div>
    </div>
